...
class Config {
  final String mapKey = "map_api_key_update_here";

  final String googleapis = "https://maps.googleapis.com/maps/api";

  //https://maps.googleapis.com/maps/api/place/autocomplete/json?input=qu&types=geocode&key=map_api_key_update_here&components=country:SA&language=ar
  ...
  //https://maps.googleapis.com/maps/api/geocode/json?latlng=34.1358593,-117.922066&key=map_api_key_update_here&components=country:SA&language=ar
  ...
  //https://maps.googleapis.com/maps/api/place/details/json?place_id=ChIJzzgyJU--woARcZqceSdQ3dM&key=map_api_key_update_here&components=country:SA&language=ar
  String findPlaceDetails(String placeID) {
    return googleapis +
        "/place/details/json?place_id=$placeID&key=$mapKey&components=country:SA&language=ar";
  }

  //https://maps.googleapis.com/maps/api/directions/json?origin=23.885942,45.079162&destination=21.5202768,39.2308587&key=map_api_key_update_here&components=country:SA&language=ar
